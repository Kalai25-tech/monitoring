...
PROMETHEUS_PRIVATE_IP="${prometheus_private_ip}"   # keep — this IS a Terraform var
LOKI_PRIVATE_IP="${loki_private_ip}"               # keep — this IS a Terraform var

echo "Prometheus IP: $${PROMETHEUS_PRIVATE_IP}"    # escape — bash var
echo "Loki IP: $${LOKI_PRIVATE_IP}"                # escape — bash var
